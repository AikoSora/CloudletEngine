...
class Message:
	...
	def callback_buttons(self, *args):
		if self.keyboard["one_time"]:
			self.keyboard["one_time"] = False
			self.keyboard["inline"] = True
			self.keyboard["buttons"] = []
	...
	async def __call__(self, text=None, attachment=None, sticker_id=None, user_id=None, user_ids=None):
